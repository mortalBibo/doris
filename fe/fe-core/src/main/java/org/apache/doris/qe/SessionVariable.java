...
public class SessionVariable implements Serializable, Writable {
    ...
    public static final String PREFERRED_BLOCK_SIZE_ROWS = "preferred_block_size_rows";
    ...
    // Target output block row count limit for adaptive batch size. Default 65535.
    @VariableMgr.VarAttr(name = PREFERRED_BLOCK_SIZE_ROWS, needForward = true,
            description = {"目标输出 Block 行数上限，自适应 batch size 功能使用，默认 65535",
                "Target output block row count limit for adaptive batch size. Default 65535."})
    public long preferredBlockSizeRows = 65535L;
    ...
    public TQueryOptions toThrift() {
        ...
        tResult.setPreferredBlockSizeRows(preferredBlockSizeRows);
